...
def generate(in_x, in_y, out_x, out_y, scale, anchors, B, C, batch_size, data_path):
    ...
    default_width_height = default_lower_right_corner[b] - default_upper_left_corner[b];
    ...
    for b in range(batch_size):
        ...
        default_areas = default_areas.reshape((-1, out_x*out_y, B))
